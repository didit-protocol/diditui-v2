...
export const mdxComponents = {
    ...
    return (
      <h2
        id={props.children
          ...
          .toLowerCase()}
        className={cn(
          "font-heading *:[code]:text-2xl mt-12 scroll-m-28 text-2xl font-medium tracking-tight first:mt-0 lg:mt-20 [&+p]:!mt-4",
          className,
        )}
        {...props}
      />
  ...
  h3: ({ className, ...props }: React.ComponentProps<"h3">) => (
    <h3
      className={cn(
        "font-heading *:[code]:text-xl mt-8 scroll-m-28 text-xl font-semibold tracking-tight",
        className,
      )}
      {...props}
    />
  ...
  Steps: ({ ...props }) => (
    <div className="[&>h3]:step steps *:[h3]:first:!mt-0 mb-12 [counter-reset:step]" {...props} />
  ),
